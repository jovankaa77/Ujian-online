  ...
  const handleSaveAllEdits = async () => {
    ...
    try {
      ...
      setSessions(prev => prev.map(s =>
        s.id === editingScoreSession.id ? { ...s, scoreReduction } : s
      ));
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50 p-4">
          <div className="bg-gray-800 rounded-xl shadow-2xl w-full max-w-md mx-4">
            ...
            <div className="flex justify-between items-center p-5 border-b border-gray-700">
              <div>
                <h3 className="text-xl font-bold">Edit Nilai</h3>
            ...
            <div className="p-5 space-y-5">
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">Dikurangi dari total nilai akhir peserta ujian.</p>
              </div>

              <div className="grid grid-cols-2 gap-3 text-sm">
                <div className="bg-gray-700 border border-gray-600 p-3 rounded-lg">
                  <div className="text-gray-400 text-xs font-bold mb-1">Nilai Akhir Saat Ini</div>
            ...
            <div className="p-5 border-t border-gray-700">
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  className="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-5 rounded-lg disabled:opacity-60"
                >
                  {isSavingEdit ? 'Menyimpan...' : 'Simpan Nilai'}
                </button>
              </div>
            </div>
          </div>
